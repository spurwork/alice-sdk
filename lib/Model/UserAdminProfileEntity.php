...
/**
 * UserAdminProfileEntity Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserAdminProfileEntity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserAdminProfileEntity';
...
self::PROFILE_NAME_ADMIN,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['num_invoices'] = isset($data['num_invoices']) ? $data['num_invoices'] : 0;
    }
    ...
    {
        return $this->container['num_invoices'];
    }

    /**
     * Sets num_invoices
     *
     * @param int $num_invoices Number of invoices
     *
     * @return $this
     */
    public function setNumInvoices($num_invoices)
    {
        $this->container['num_invoices'] = $num_invoices;
