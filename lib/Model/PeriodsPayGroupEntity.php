...
/**
 * PeriodsPayGroupEntity Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PeriodsPayGroupEntity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PeriodsPayGroupEntity';
...
'employee_count' => 'getEmployeeCount'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['name'] = isset($data['name']) ? $data['name'] : 'Weekly Group';
     ...
     * Sets name
     *
     * @param string $name Name of pay group
     *
     * @return $this
     */
     ...
     * Sets employee_count
     *
     * @param int $employee_count Number of employees on periods for this pay group
     *
     * @return $this
     */
