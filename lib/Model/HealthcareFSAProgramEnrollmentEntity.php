...
/**
 * HealthcareFSAProgramEnrollmentEntity Class Doc Comment
 *
 * @category Class
 * @description Update healthcare FSA enrollment
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class HealthcareFSAProgramEnrollmentEntity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HealthcareFSAProgramEnrollmentEntity';
...
'plan_year' => 'getPlanYear'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status'] = isset($data['status']) ? $data['status'] : 'qualified';
        ...
        $this->container['purpose'] = isset($data['purpose']) ? $data['purpose'] : 'general';
     ...
     * Sets purpose
     *
     * @param string $purpose General or limited purpose
     *
     * @return $this
     */
